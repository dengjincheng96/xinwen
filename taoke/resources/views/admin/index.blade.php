	...
	<ul>
		<li>
			...
			<ul class="sub_menu">
				...
				<li><a href="{{url('admin/article/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加新闻</a></li>
				<li><a href="{{url('admin/article')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>新闻列表</a></li>
			</ul>
		</li>
		<li>
...
<div class="bottom_box">
	CopyRight © 2018. Powered By <a href="http://www.houdunwang.com">http://www.baidu.com</a>.
</div>
<!--底部 结束-->
